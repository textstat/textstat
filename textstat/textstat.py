...
class textstatistics:
    ...
    def words_per_sentence(self, text):
        ...
        return self.lexicon_count(text) / s_count
    ...
    def count_arabic_syllables(self, text):
        ...
        for t in tashkeel:
            for i, c in enumerate(char_list):
                ...
                if i + 1 < len(char_list) and c == t:
                    # count long syllables if it is followed by an alef, waw or yaaA
        ...
        # tanween fatih | tanween damm | tanween kasr | shadda
        stress_pattern = re.compile(r'[\u064B\u064C\u064D\u0651]')
        stress_count = stress_pattern.findall(text)
    ...
    def count_faseeh(self, text):
        ...
        # hamza nabira | hamza satr | amza waw | Thal | DHaA
        unipattern = re.compile(r'[\u0626\u0621\u0624\u0630\u0638]')
        
        # waw wa alef | waw wa noon
    ...
    def osman(self, text):
        ...
        return 200.791 - (1.015 * self.words_per_sentence(text)) - (24.181 * (complex_word_rate + syllables_per_word + faseeh_per_word + long_word_rate))
