...
@pytest.mark.parametrize(
    ...
    [
        ...
        (resources.EMPTY_STR, "en_US", 2, 0.0),
        (resources.EASY_TEXT, "en_US", 1, -0.227),
        (resources.EASY_TEXT, "en_US", 2, 0.259),
        (resources.EASY_TEXT, "en_US", 3, 0.703),
        (resources.EASY_TEXT, "en_US", 4, 0),
        (resources.SHORT_TEXT, "en_US", 1, 3.006),
        (resources.PUNCT_TEXT, "en_US", 1, 0.088),
        (resources.LONG_TEXT, "en_US", 1, 1.108),
        (resources.GERMAN_SAMPLE_A, "de_DE", 1, 1.441),
        (resources.GERMAN_SAMPLE_B, "de_DE", 1, 11.249),
    ],
)
